  ...
  theme: {
    extend: {
      colors: {
        ...
        panel2: "#eeeef0",
        // Phase 41: reverted the Phase 39 darkening — the newer reference
        // the user pointed to (Packify.ai) leans on soft shadows and
        // near-invisible borders rather than bold outlines, so the heavier
        // gray read as inconsistent with that cleaner direction.
        edge: {
          DEFAULT: "#e4e4e7",
        },
        edge2: "#d4d4d8",
